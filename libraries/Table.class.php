...
class PMA_Table
{
     ...
     */
    public static function isView($db = null, $table = null)
    {
     ...
     */
    public static function isUpdatableView($db = null, $table = null)
    {
        if (empty($db) || empty($table)) {
            return false;
        }
     ...
     */
    public static function analyzeStructure($db = null, $table = null)
    {
        if (empty($db) || empty($table)) {
            return false;
        }
     ...
     * @return mixed
     */
    public static function sGetStatusInfo(
        $db,
        $table,
        $info = null,
        $force_read = false,
     ...
     */
    public static function isValidName($table_name)
    {
