...
function PMA_backquoteSplit($text)
{
    ...
    while ($pos <= $final_pos) {
        ...
        $elements[] = /*overload*/mb_substr(
            $text,
            $first_backquote,
            $second_backquote - $first_backquote + 1
        );
 ...
 */
function PMA_getSQLToCreateForeignKey(
    $table,
    $field,
    $foreignDb,
    $foreignTable,
 ...
 * @return string
 */
function PMA_getHtmlForCommonForm(
    $db,
    $table,
    $columns,
    $cfgRelation,
 ...
 * @return string
 */
function PMA_getHtmlForInternalRelationForm(
    $columns,
    $tbl_storage_engine,
    $existrel,
    $db
 ...
 * @return string
 */
function PMA_getHtmlForInternalRelationRow(
    $save_row,
    $i,
    $odd_row,
    $existrel,
 ...
 * @return string
 */
function PMA_getHtmlForForeignKeyForm(
    $columns,
    $existrel_foreign,
    $db,
    $tbl_storage_engine,
 ...
 * @return string html
 */
function PMA_getHtmlForForeignKeyRow(
    $one_key,
    $odd_row,
    $columns,
    $i,
 ...
 * @return string
 */
function PMA_handleUpdateForDisplayField(
    $disp,
    $display_field,
    $db,
    $table,
 ...
 * @return string
 */
function PMA_getQueryForDisplayUpdate(
    $disp,
    $display_field,
    $db,
    $table,
 ...
 * @return string
 */
function PMA_handleUpdatesForInternalRelations(
    $destination_db,
 ...
 * @return string
 */
function PMA_getQueryForInternalRelationUpdate(
    $multi_edit_columns_name,
    $master_field_md5,
    $foreign_db,
    $destination_table,
 ...
 * @return array
 */
function PMA_handleUpdateForForeignKey(
    $multi_edit_columns_name,
    $master_field_md5,
    $destination_foreign_table,
    $destination_foreign_column,
