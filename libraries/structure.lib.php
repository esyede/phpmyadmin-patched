 ...
 *                $tracking_icon)
 */
function PMA_getHtmlForActionLinks(
    $current_table,
    $table_is_view,
    $tbl_url_query,
    $titles,
 ...
 */
function PMA_getHtmlBodyForTableSummary(
    $num_tables,
    $server_slave_status,
    $db_is_system_schema,
    $sum_entries,
 ...
 * @return string $html_output
 */
function PMA_getHtmlForCheckAllTables(
    $pmaThemeImage,
    $text_dir,
    $overhead_check,
    $db_is_system_schema,
 ...
 * @return string $html_output
 */
function PMA_getHtmlForInsertEmptyDropActionLinks(
    $tbl_url_query,
    $table_is_view,
    $titles,
    $empty_table,
 ...
 * @return string $html_output
 */
function PMA_getHtmlForShowStats(
    $tbl_url_query,
    $formatted_size,
    $unit,
    $overhead
 ...
 * @return string $html_output
 */
function PMA_getHtmlForNotNullEngineViewTable(
    $table_is_view,
    $current_table,
    $collation,
    $is_show_stats,
 ...
 */
function PMA_getAliasAndTrueName(
    $tooltip_aliasname,
    $current_table,
    $tooltip_truename
) {
 ...
 * @return array
 */
function PMA_getStuffForEngineTypeTable(
    $current_table,
    $db_is_system_schema,
    $is_show_stats,
    $table_is_view,
 ...
 */
function PMA_getHtmlTableStructureRow(
    $row,
    $rownum,
 ...
 * @return string $html_output
 */
function PMA_getHtmlForDropColumn(
    $tbl_is_view,
    $db_is_system_schema,
    $url_query,
    $field_encoded,
 ...
 * @return string $html_output
 */
function PMA_getHtmlForCheckAllTableColumn(
    $pmaThemeImage,
    $text_dir,
    $tbl_is_view,
    $db_is_system_schema,
    ...
    if (! $tbl_is_view && ! $db_is_system_schema) {
        ...
        if (isset($GLOBALS['cfgRelation']['central_columnswork'])
            ...
            $html_output .= PMA_Util::getButtonOrImage(
                'submit_mult',
                'mult_submit',
                'submit_mult_central_columns_add',
 ...
 * @return string $html_output
 */
function PMA_getHtmlForOptionalActionLinks(
    $url_query,
    $tbl_is_view,
    $db_is_system_schema
) {
 ...
 * @return string $html_output
 */
function getHtmlForRowStatsTable(
    $showtable,
    $tbl_collation,
    $is_innodb,
    $mergetable,
 ...
 * @return string $html_output
 */
function PMA_getHtmlForActionRowInStructureTable(
    $type,
    $tbl_storage_engine,
    $class,
    $hasField,
 ...
 * @return string $html_output
 */
function PMA_getHtmlForFullTextAction(
    $tbl_storage_engine,
    $type,
    $url_query,
    $row,
 ...
 * @return string $html_output;
 */
function PMA_getHtmlForActionsInTableStructure(
    $type,
    $tbl_storage_engine,
    $primary,
    $field_name,
 ...
 * @return string $html_output
 */
function PMA_getHtmlForDisplayTableStats(
    $showtable,
    $table_info_num_rows,
    $tbl_is_view,
    $db_is_system_schema,
 ...
 * @return void
 */
function PMA_displayTableBrowseForSelectedColumns(
    $db,
    $table,
    $goto,
    $pmaThemeImage
    ...
    if ($changes) {
        ...
        $ajax_response->addJSON(
            ...
            PMA_getHtmlForFavoriteAnchor(
                $db,
                array('TABLE_NAME' => $favorite_table),
                $titles
            )
        );
    } else {
