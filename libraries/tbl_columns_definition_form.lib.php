...
function PMA_getHtmlForTableNameAndNoOfColumns()
{
    ...
    $html .= sprintf(
        __('Add %s column(s)'),
        '<input type="text" id="added_fields" '
 ...
 * @return string
 */
function PMA_getHtmlForTableCreateOrAddField(
    $action,
    $form_params,
    $content_cells,
    $header_cells
 ...
 * @return array
 */
function PMA_handleRegeneration(
    $columnNumber,
    $submit_fulltext,
    $comments_map,
    $mime_map
 ...
 * @return string
 */
function PMA_getHtmlForColumnType(
    $columnNumber,
    $ci,
    $ci_offset,
    $type_upper,
 ...
 * @return string
 */
function PMA_getHtmlForTransformationOption(
    $columnNumber,
    $ci,
    $ci_offset,
    $columnMeta,
 ...
 * @return string
 */
function PMA_getHtmlForMimeType(
    $columnNumber,
    $ci,
    $ci_offset,
    $available_mime,
 ...
 * @return string
 */
function PMA_getHtmlForTransformation(
    $columnNumber,
    $ci,
    $ci_offset,
    $available_mime,
 ...
 * @return string
 */
function PMA_getHtmlForMoveColumn(
    $columnNumber,
    $ci,
    $ci_offset,
    $move_columns,
 ...
 * @return string
 */
function PMA_getHtmlForColumnComment(
    $columnNumber,
    $ci,
    $ci_offset,
    $columnMeta,
 ...
 * @return string
 */
function PMA_getHtmlForColumnAutoIncrement(
    $columnNumber,
    $ci,
    $ci_offset,
    $columnMeta
 ...
 * @return string
 */
function PMA_getHtmlForColumnAttribute(
    $columnNumber,
    $ci,
    $ci_offset,
 ...
 * @return string
 */
function PMA_getHtmlForColumnLength(
    $columnNumber,
    $ci,
    $ci_offset,
 ...
 * @return string
 */
function PMA_getHtmlForColumnDefault(
    $columnNumber,
    $ci,
    $ci_offset,
    $type_upper,
