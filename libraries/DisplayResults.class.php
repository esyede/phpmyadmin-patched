...
class PMA_DisplayResults
{
    ...
    private function _getTableHeaders(
        ...
        for ($j = 0; $j < $this->__get('fields_cnt'); $j++) {
            ...
            //  where-query.
            $condition_field = (
                isset($highlight_columns[$fields_meta[$i]->name])
                || isset(
    ...
    private function _getOptionsBlock()
    {
        ...
        $options_html .= '<div class="formelement">'
            . PMA_Util::getCheckbox(
                'display_binary',
                __('Show binary contents'),
                ! empty($_SESSION['tmpval']['display_binary']),
                false,
            ...
            . PMA_Util::getCheckbox(
                'display_blob',
                __('Show BLOB contents'),
                ! empty($_SESSION['tmpval']['display_blob']),
                false,
        ...
        $options_html .= '<div class="formelement">'
            . PMA_Util::getCheckbox(
                ...
                ! empty($_SESSION['tmpval']['hide_transformation']),
                false,
