 ...
 */
  class ShapeFile
  {
      ...
      public function _loadDBFHeader()
      {
      ...
      public function _deleteRecordFromDBF($index)
      {
      ...
      public function _openSHPFile($toWrite = false)
      {
      ...
      public function _openSHXFile($toWrite = false)
      {
      ...
      public function _openDBFFile($toWrite = false)
      {
  ...
  class ShapeRecord
  {
      ...
      public function _savePoint($data)
      {
          fwrite($this->SHPFile, packDouble($data["x"]));
          fwrite($this->SHPFile, packDouble($data["y"]));
      }

      public function _loadNullRecord()
      {
          $this->SHPData = array();
      }

      public function _saveNullRecord()
      {
          //Don't save anything
      }

      public function _loadPointRecord()
      {
          $this->SHPData = $this->_loadPoint();
      }

      public function _savePointRecord()
      {
      ...
      public function _saveMultiPointRecord()
      {
      ...
      public function _savePolyLineRecord()
      {
          fwrite($this->SHPFile, pack("dddd", $this->SHPData["xmin"], $this->SHPData["ymin"], $this->SHPData["xmax"], $this->SHPData["ymax"]));
      ...
      public function _loadPolygonRecord()
      {
          $this->_loadPolyLineRecord();
      }

      public function _savePolygonRecord()
      {
          $this->_savePolyLineRecord();
      }
