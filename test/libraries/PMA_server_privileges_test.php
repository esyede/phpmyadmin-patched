...
class PMA_ServerPrivileges_Test extends PHPUnit_Framework_TestCase
{
     ...
     * @return void
     */
    public function testPMAGetUserSpecificRights()
    {
        // Setup for the test
     ...
     * @return void
     */
    public function testPMAGetHtmlForUserRights()
    {
        // Test case 1
        $db_rights = array(
            'y' => array(
     ...
     * @return void
     */
    public function testPMAGetHtmlForSelectDbInEditPrivs()
    {
     ...
     * @return void
     */
    public function testPMADisplayTablesInEditPrivs()
    {
        // Setup for the test
